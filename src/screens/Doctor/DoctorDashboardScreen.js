    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.doctorName}>Dashboard</Text>
        </View>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.cardDescription}>
            Manage patient reports and medical records
          </Text>
        </View>

        <View style={styles.card}>
          <Icon name="assignment" size={32} color={colors.primary} />
          <Text style={styles.featureTitle}>Assign Reports</Text>
          <Text style={styles.featureDescription}>
            Upload and assign medical reports to patients
          </Text>
        </View>
