  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center py-5">
      ...
      <div className="flex items-center space-x-4">
        <img src="logo.png" className="h-20 w-20" alt="MedLock Logo" />
        <div>
          <h1 className="text-3xl font-bold text-[#0b4f4a]">MedLock</h1>
          <p className="text-sm text-[#0b4f4a]">Hospital's Portal</p>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-5">
        <div className="text-right hidden sm:block">
          <p className="text-base font-medium text-[#0b4f4a]">Hospital Name</p>
          <p className="text-sm text-[#0b4f4a]">Hospital ID: #D001</p>
        </div>
