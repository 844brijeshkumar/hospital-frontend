...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-emerald-50 text-gray-800">
      <header className="w-full glass-effect medical-shadow z-50 relative">
          ...
          <div className="hidden md:flex space-x-8 text-gray-700 font-semibold">
            {nav.map((page, index) => (
              <a
                href={page.link}
                key={index}
                className="hover:text-teal-600 transition-all duration-300 cursor-pointer relative group px-2 py-1"
              >
                {page.name}
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full glass-effect medical-shadow py-6">
            <div className="flex flex-col items-center space-y-4">
              {nav.map((page, index) => (
                <a
                  ...
                  key={index}
                  onClick={toggleMenu}
                  className="hover:text-teal-600 transition-all duration-300 text-lg cursor-pointer font-semibold px-4 py-2 rounded-lg hover:bg-teal-50"
                >
                  {page.name}
                </a>
              ))}
